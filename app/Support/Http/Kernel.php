...
use Support\Http\Middleware\EnsureTenantIdMiddleware;
...
use Support\Http\Middleware\ValidateSignature;
use Support\Http\Middleware\VerifyCsrfToken;
use Support\Http\Middleware\VerifyJWTToken;
use Support\Http\Middleware\VerifyApiKey;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'ensure.tenant' => EnsureTenantIdMiddleware::class,
        'jwt.verify' => VerifyJWTToken::class,
        'apiKey.verify' => VerifyApiKey::class,
    ];
}
