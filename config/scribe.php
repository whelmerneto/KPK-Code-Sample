...
return [
    ...
    'routes' => [
        [
            ...
            'match' => [
                 ...
                 */
                'prefixes' => ['api/platform/auth/custom-html*'],
    ...
    'try_it_out' => [
         ...
         */
        'base_url' => 'https://dev-backend.themembers.dev.br',
    ...
    'auth' => [
         ...
         */
        'use_value' => 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..g-k6ZFBDzjy1YBp-6VojNuj8v2twubYLzBIEUFt8yRY',
         ...
         */
        'extra_info' => 'Você pode pegar rapidamente um token para qualquer usuário usando a extensão TheTokens',
    ],
     ...
     */
    'intro_text' => <<<'INTRO'
Esta documentação tem como objetivo fornecer todas as informações necessárias para trabalhar com a nossa API.

<aside>Ao rolar a página, você verá exemplos de código para trabalhar com a API em diferentes linguagens de programação
na área escura à direita (ou como parte do conteúdo em dispositivos móveis). Você pode alternar a linguagem utilizada
usando as abas localizadas no canto superior direito (ou a partir do menu de navegação no canto superior esquerdo em
dispositivos móveis).</aside>
INTRO
    ,
     ...
     *
     */
    'logo' => 'https://cdn.greatsoftwares.com.br/arquivos/paginas_editor/3768-f0ac8155e7ba585692d2963314289494.png',
     ...
     */
    'database_connections_to_transact' => ['memory'],
];
